...
function Main(props) {
  ...
  const selectAbout = useCallback(() => {
    smoothScrollTop();
    document.title = "RandomTechie - About";
  ...
  const selectServices = useCallback(() => {
    smoothScrollTop();
    document.title = "RandomTechie - Services";
  ...
  const selectPortfolio = useCallback(() => {
    smoothScrollTop();
    document.title = "RandomTechie - Portfolio";
    setSelectedTab("Portfolio");
  }, [setSelectedTab]);

  const selectPrivacyPolicy = useCallback(() => {
    smoothScrollTop();
    document.title = "RandomTechie - PrivacyPolicy";
    setSelectedTab("PrivacyPolicy");
  }, [setSelectedTab]);

  const selectContact = useCallback(() => {
    smoothScrollTop();
    document.title = "RandomTechie - Contact";
